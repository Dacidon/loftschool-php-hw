<?php
include 'dbConnection/class.db.php';
include 'class.burgers.php';
...
$getUser = $burger->getUserByEmail($email);

if ($getUser) {
    $userId = $getUser['id'];
    $burger->incOrders($getUser['id']);
    $orderNumber = $getUser['order_number'] + 1;
} else {
    $orderNumber = 1;
